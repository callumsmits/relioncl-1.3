...
public:
	...
	*/
    ...
    void get2DFourierTransformD(MultidimArray<Complex > &img_out, Matrix2D<double> &A, bool inv)
    {
        // Rotation of a 3D Fourier Transform
        switch (ref_dim)
        {
	...
	*/
    ...
    void projectD(MultidimArray<Complex > &img_out, Matrix2D<double> &A, bool inv);
