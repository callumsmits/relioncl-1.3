...
//    CL_global_memsize /= 2;
    ...
    char clCode[] = {"#pragma\tOPENCL\tEXTENSION\tcl_khr_fp64\t:\tenable\n"
        ...
        "}\n"
        "\n"
        "kernel\tvoid\tcalculateSWSNoiseEstNormCorrection(global\tdouble2*\tFref,\tglobal\tdouble2*\tFimg,\tglobal\tdouble*\tweight,\tglobal\tint*\tMresol_fine,\tglobal\tdouble*\tsigma2_noise,\tglobal\tdouble*\tdata_vs_prior,\tglobal\tdouble*\tsumXA,\tglobal\tdouble*\tsumAA,\tconst\tint\tprojSize,\tconst\tint\torientationsPerTrans,\tconst\tuint\tlimit)\t{\n"
        "\t\t\t\t\n"
        "\t\t\t\tsize_t\tgi\t=\tget_global_id(0);\n"
        "\t\t\t\t\n"
