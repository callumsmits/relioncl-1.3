...
public:
	...
	*/
    ...
    void set2DFourierTransformverbose(const MultidimArray<Complex > &img_in,
                               const Matrix2D<double> &A, bool inv,
                               const MultidimArray<double> *Mweight = NULL)
    {
        // Back-rotation of a 3D Fourier Transform
        switch (ref_dim)
        {
            case 2:
                ...
                break;
            case 3:
                backprojectverbose(img_in, A, inv, Mweight);
                break;
            default:
                REPORT_ERROR("Backprojector::set2DSlice%%ERROR: Dimension of the data array should be 2 or 3");
        }
	...
	*/
    ...
    void backprojectverbose(const MultidimArray<Complex > &img_in,
                     const Matrix2D<double> &A, bool inv,
                     const MultidimArray<double> *Mweight = NULL);
